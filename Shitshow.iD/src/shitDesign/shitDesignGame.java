...
public class shitDesignGame {
	...
	public static void main(String[] args) {
		...
		//uses the image loading method from c-sharpcorner.com to give a prompt to upload an image
		...
		p = p.toLowerCase();
		//sends the name and size of canvas as well as your input to the visuals section
